...
void main()
{
    ...
    vec3 triangle_normal = normalize(cross(dFdx(model_pos.xyz / model_pos.w), dFdy(model_pos.xyz / model_pos.w)));
    ...
    float world_normal_z = slope.actived ? (normalize(slope.volume_world_normal_matrix * triangle_normal)).z : 0.0;
